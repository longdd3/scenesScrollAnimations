...
},{"./gsap-core.js":"P74P","./CSSPlugin.js":"KE4Q"}],"nGM1":[function(require,module,exports) {
"use strict";
...
function loadingAni() {
  splitinntexts.forEach(function (splitinntext) {
    var words = _toConsumableArray(splitinntext.querySelectorAll(".word"));
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        chars.forEach(function (char) {
          return _gsap.default.set(char.parentNode, {
            perspective: 4000
          });
        });
        ...
        tl.fromTo(chars, {
          ...
          rotationX: function rotationX() {
            return _gsap.default.utils.random(-500, -200);
          }
        }, {
          ease: 'power1.inOut',
          opacity: 1,
...
loadingAni();
},{"splitting":"Ko7r","gsap":"f8Z0"}]},{},["nGM1"], null)